@echo off
echo Creando enlace simbolico para las imagenes del frontend...
echo.
...
if %errorLevel% == 0 (
    ...
    REM Crear el enlace simbolico
    mklink /D "images" "C:\Users\Lenovo\Downloads\cafeteriaFanny\cafeteriafanny\src\assets\images"
    ...
    echo 3. Navegue al directorio y ejecute: create-symlink.bat
)
